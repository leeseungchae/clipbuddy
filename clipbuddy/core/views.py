...
def add_conversation(request):
    if request.method == 'POST' and request.body:
        ...
        try:
            ...
            response = JsonResponse({'message': data['message']}, status=200)
            return response
        except Exception as e:
